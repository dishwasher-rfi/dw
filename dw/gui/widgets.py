...
class PolaViewerWidget(MainWidget):
    ...
    * mu_toggle: toggle physical measure units on/off on the main plot and cross section plots
    ...
    def current_table_changed(self, row):
        ...
        self.image.a_ascension = math.degrees(self.data_ref.get_ascension(row))
        self.image.a_declination = math.degrees(self.data_ref.get_declination(row))
        self.image.a_azimuth = math.degrees(self.data_ref.get_azimuth(row))
        self.image.a_elevation = math.degrees(self.data_ref.get_elevation(row))
