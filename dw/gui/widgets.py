...
#        add_actions(toolbar, [flag_selected])
    ...
    def current_table_changed(self, row):
        ...
        self.image.a_ascension = degrees(self.data_ref.get_ascension(row)[0])
        self.image.a_declination = degrees(self.data_ref.get_declination(row)[0])
        self.image.a_azimuth = degrees(self.data_ref.get_azimuth(row)[0])
        self.image.a_elevation = degrees(self.data_ref.get_elevation(row)[0])
...
class PolaViewerWidget(MainWidget):
    ...
    * mu_toggle: toggle physical measure units on/off on the main plot and cross section plots
    ...
    def current_table_changed(self, row):
        ...
        self.image.a_ascension = degrees(self.data_ref.get_ascension(row))
        self.image.a_declination = degrees(self.data_ref.get_declination(row))
        self.image.a_azimuth = degrees(self.data_ref.get_azimuth(row))
        self.image.a_elevation = degrees(self.data_ref.get_elevation(row))
